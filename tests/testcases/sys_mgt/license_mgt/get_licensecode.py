...
from conf.url_configs import licenseUrl
...
class GetLicense(MyUnit):
    """系统设置》授权管理》获取license"""

    def getTest(self, tx):
        logger.info("****************获取license接口开始****************")
...
__generateTestCases(GetLicense, "sysMgtData.xlsx", "getLicense")
